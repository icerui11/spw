...
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { Connected_LED }]; #IO_L8P_T1_34 Sch=led[1]
...
set_property -dict { PACKAGE_PIN M4    IOSTANDARD LVCMOS33 } [get_ports { UART_RX }]; #IO_L19P_T3_34 Sch=pio[02]
...
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { S_in }]; #IO_L21P_T3_DQS_34 Sch=pio[06]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { D_in  }]; #IO_L21N_T3_DQS_34 Sch=pio[07]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { S_out }]; #IO_L22P_T3_34 Sch=pio[08]
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { D_out }]; #IO_L22N_T3_34 Sch=pio[09]
