...
set_property IOSTANDARD DIFF_SSTL12 [get_ports mmcm_clk_in1_n]
set_property PACKAGE_PIN K22 [get_ports mmcm_clk_in1_p]
set_property PACKAGE_PIN K23 [get_ports mmcm_clk_in1_n]
set_property IOSTANDARD DIFF_SSTL12 [get_ports mmcm_clk_in1_p]
...
set_property IOSTANDARD LVDS [get_ports spw_Din_n]
set_property PACKAGE_PIN Y18 [get_ports spw_Din_p]
set_property PACKAGE_PIN AA18 [get_ports spw_Din_n]
set_property IOSTANDARD LVDS [get_ports spw_Din_p]
set_property IOSTANDARD LVDS [get_ports spw_Sin_n]
set_property PACKAGE_PIN Y17 [get_ports spw_Sin_p]
set_property PACKAGE_PIN AA17 [get_ports spw_Sin_n]
set_property IOSTANDARD LVDS [get_ports spw_Sin_p]
set_property IOSTANDARD LVDS [get_ports spw_Dout_n]
set_property PACKAGE_PIN AB17 [get_ports spw_Dout_p]
set_property PACKAGE_PIN AC17 [get_ports spw_Dout_n]
set_property IOSTANDARD LVDS [get_ports spw_Dout_p]
set_property IOSTANDARD LVDS [get_ports spw_Sout_n]
set_property PACKAGE_PIN AA20 [get_ports spw_Sout_p]
set_property PACKAGE_PIN AB20 [get_ports spw_Sout_n]
set_property IOSTANDARD LVDS [get_ports spw_Sout_p]
...
set_property PACKAGE_PIN H11 [get_ports rst_in]
...
#set_false_path -from [get_ports rst_in] -to [get_pins u_spw_hw/reset_reg_lopt_replica/D]
set_false_path -from [get_ports rst_in] -to [get_pins u_spw_hw/reset_reg/D]
set_false_path -from [get_pins u_spw_hw/u_controller/error_out_reg/C] -to [get_ports spw_error]


set_false_path -from [get_ports spw_Din_p] -to [get_pins u_spw_hw/u_spw_wrap/g_mode_select.RxD_IDDR_REG/D]
set_false_path -from [get_ports spw_Din_n] -to [get_pins u_spw_hw/u_spw_wrap/g_mode_select.RxD_IDDR_REG/D]
set_false_path -from [get_ports spw_Sin_p] -to [get_pins u_spw_hw/u_spw_wrap/g_mode_select.RxD_IDDR_REG/D]
set_false_path -from [get_ports spw_Sin_n] -to [get_pins u_spw_hw/u_spw_wrap/g_mode_select.RxD_IDDR_REG/D]

set_false_path -from [get_pins u_spw_hw/u_spw_wrap/u_spw/u_tx_ds/D_reg/C] -to [get_ports spw_Dout_p]
set_false_path -from [get_pins u_spw_hw/u_spw_wrap/u_spw/u_tx_ds/D_reg/C] -to [get_ports spw_Dout_n]
set_false_path -from [get_pins u_spw_hw/u_spw_wrap/u_spw/u_tx_ds/S_reg/C] -to [get_ports spw_Sout_p]
set_false_path -from [get_pins u_spw_hw/u_spw_wrap/u_spw/u_tx_ds/S_reg/C] -to [get_ports spw_Sout_n]
